    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('lavender', 'むらさき'), ('honeydew', 'きみどり'), ('floralwhite', 'しろ'), ('papayawhite', 'オレンジ'), ('lavenderblush', 'ピンク'), ('mistyrose', 'ピンクオレンジ'), ('lightcyan', 'あお'), ('whitesmoke', 'グレー'), ('lightpink', 'あか'), ('palegreen', 'みどり')], max_length=13)),
