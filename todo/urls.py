...
urlpatterns = [
    ...
    path('todo_category/add_tag/', views.add_tag, name='add_tag'),
    path('todo_category/update_tag/', views.update_tag, name='update_tag'),
    path('todo_category/delete_tag/', views.delete_tags, name='delete_tag'),
